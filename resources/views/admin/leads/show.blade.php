        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="bg-white shadow sm:rounded-lg p-6">
                <div class="grid md:grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                        <div class="text-gray-600">Sales Rep</div>
                        <div>{{ optional($lead->salesRep)->name ?: '—' }}</div>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div>{{ $lead->updated_at->format('Y-m-d H:i') }}</div>
                    </div>
                </div>
            ...
            <div class="bg-white shadow sm:rounded-lg p-6">
                ...
                <form action="{{ route('admin.leads.note', $lead) }}" method="POST" class="flex flex-wrap gap-2 text-sm mb-4">
                    @csrf
