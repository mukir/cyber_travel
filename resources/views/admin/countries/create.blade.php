<x-app-layout>
  <x-slot name="header">
    <div class="flex items-center justify-between">
      <h2 class="font-semibold text-xl text-gray-800 leading-tight">Add Country</h2>
  ...
  <div class="py-8">
    <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
      <div class="bg-white p-6 shadow sm:rounded-lg">
        <form method="POST" action="{{ route('admin.countries.store') }}" class="grid gap-4">
          @csrf
          <div>
          ...
          <div>
            ...
            <input name="code" class="mt-1 w-full rounded border p-2 uppercase" value="{{ old('code') }}" />
