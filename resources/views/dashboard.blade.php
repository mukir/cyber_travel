                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <h4 class="text-lg font-medium text-gray-900">My Applications</h4>
                                <p class="text-sm text-gray-500">View and manage your reservations</p>
                            </div>
                        </div>
                        <div class="mt-4">
                            <a href="{{ route('client.applications') }}" class="inline-flex items-center px-4 py-2 bg-green-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-700 focus:bg-green-700 active:bg-green-900 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                View Applications
                            </a>
                        </div>
                    </div>
